...
RegBankLegalizeRules::RegBankLegalizeRules(const GCNSubtarget &_ST,
  ...
  addRulesForIOpcs({amdgcn_cvt_sr_bf8_f32, amdgcn_cvt_sr_fp8_f32,
                   ...
                   Standard)
      .Uni(S32, {{UniInVgprS32}, {IntrId, Vgpr32, Vgpr32, Vgpr32, Imm}})
      .Div(S32, {{Vgpr32}, {IntrId, Vgpr32, Vgpr32, Vgpr32, Imm}});

  addRulesForIOpcs({amdgcn_cvt_f32_bf8, amdgcn_cvt_f32_fp8}, Standard)
      .Uni(S32, {{UniInVgprS32}, {IntrId, Vgpr32, Imm}})
      .Div(S32, {{Vgpr32}, {IntrId, Vgpr32, Imm}});

  addRulesForIOpcs({amdgcn_cvt_pk_f32_bf8, amdgcn_cvt_pk_f32_fp8})
      .Any({{UniV2S32}, {{UniInVgprV2S32}, {IntrId, Vgpr32, Imm}}})
      .Any({{DivV2S32}, {{VgprV2S32}, {IntrId, Vgpr32, Imm}}});
